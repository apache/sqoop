...
public class PhoenixBulkImportTest extends PhoenixBaseTestCase {
	 ...
	 */
	@Test
	public void testBulkloadWithNoColumnMapping() throws Exception {
    ...
    try {
	    ...
	    createPhoenixTestTable(ddl);
			...
			final String [] argv = getArgv(true, "ID", tableName, null, true, null);
	 ...
	 */
	@Test
	public void testBulkImportWithColumnMapping() throws Exception {
		Connection phoenixConnection = null;
		ResultSet rs = null;
    try {
	    ...
	    // run the import
	    String [] argv = getArgv(true, "rowid", tableName, "ROWID;ID,NAME,AGE", true , null);
	    runImport(argv);
