...
public final class DerbySchemaCreateQuery {
  ...
  public static final String QUERY_CREATE_TABLE_SQ_CONNECTOR_DIRECTIONS =
      ...
      + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQCD_SQC) + " "
      ...
      + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQCD_SQD) + " "
  ...
  public static final String QUERY_CREATE_TABLE_SQ_FORM =
      ...
      + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQF_SQC) + " "
 ...
 public static final String QUERY_CREATE_TABLE_SQ_CONFIG_DIRECTIONS =
     ...
     + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQ_CFG_DIR_CONFIG) + " "
     ...
     + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQ_CFG_DIR_DIRECTION) + " "
  ...
  public static final String QUERY_CREATE_TABLE_SQ_INPUT =
      ...
      + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQI_SQF) + " "
    ...
    public static final String QUERY_CREATE_TABLE_SQ_INPUT_RELATION =
        ...
        + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQIR_PARENT) + " "
        ...
        + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQIR_CHILD) + " "
  ...
  public static final String QUERY_CREATE_TABLE_SQ_CONNECTION =
      ...
      + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQN_SQC) + " "
...
//DDL: Create table SQ_JOB
 public static final String QUERY_CREATE_TABLE_SQ_JOB =
     ...
     + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQB_SQN) + " "
  ...
  public static final String QUERY_CREATE_TABLE_SQ_CONNECTION_INPUT =
      ...
      + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQNI_SQN) + " "
        + "FOREIGN KEY (" + CommonRepoUtils.escapeColumnName(COLUMN_SQNI_CONNECTION) + ") "
          + "REFERENCES " + CommonRepoUtils.getTableName(SCHEMA_SQOOP, TABLE_SQ_CONNECTION_NAME) + " (" + CommonRepoUtils.escapeColumnName(COLUMN_SQN_ID) + "),"
      + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQNI_SQI) + " "
...
// DDL: Create table SQ_JOB_INPUT
 public static final String QUERY_CREATE_TABLE_SQ_JOB_INPUT =
     ...
     + " CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQBI_SQB) + " "
     ...
     + " CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQBI_SQI) + " "
 ...
 public static final String QUERY_CREATE_TABLE_SQ_SUBMISSION =
   ...
   + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQS_SQB) + " "
 ...
 public static final String QUERY_CREATE_TABLE_SQ_COUNTER_SUBMISSION =
   ...
   + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQRS_SQG) + " "
   ...
   + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQRS_SQR) + " "
   ...
   + "CONSTRAINT " + CommonRepoUtils.getConstraintName(SCHEMA_SQOOP, CONSTRAINT_SQRS_SQS) + " "
